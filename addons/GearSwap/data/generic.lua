  ...
  ------------------------------------------------
	...
	function get_combat_weapon()
		if state.mainWeapon.value == "Fomalhaut" then 
			equip({main="Perun", sub="Nusku Shield", range="Fomalhaut"})
		elseif state.mainWeapon.value == "Yoichinoyumi" then 
			equip({main="Perun", sub="Nusku Shield", range="Yoichinoyumi"})
		elseif state.mainWeapon.value == "Annihilator" then 
			equip({main="Perun", sub="Nusku Shield", range="Annihilator"})
		elseif state.mainWeapon.value == "Gandiva" then 
			equip({main="Perun", sub="Nusku Shield", range="Gandiva"})
		end	
