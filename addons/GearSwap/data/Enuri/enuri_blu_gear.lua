...
------------------------------- 
	...
	sets.cleave = set_combine(sets.idle,{
		main="Vampirism",
		sub="Vampirism",
	})
	sets.dualWeild = set_combine(sets.idle,{
		main="Colada",
...
--------------------------------------
	...
	--	'Water Bomb','Spectral Floe','Tenebral Crush','Entomb',		--
	--	'Subduction','Anvil Lightning', 'Blinding Fulgor', 			--
