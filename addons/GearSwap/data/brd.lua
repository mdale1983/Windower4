...
--------------------------
	function job_setup()
		state.ExtraSongsMode = M{['description']='Extra Songs', 'FullLength', 'Dummy', 'None'}
		...
		debuffSongs = S{
			'Carnage Elegy', 'Foe Requiem VII', 'Foe Lullaby II', 'Horde Lullaby II'
		}
...
--------------------------
	function user_setup()
		...
		brd_daggers = S{'Taming sari', 'Kali', 'Atoyac', 'Aphotic Kukri', 'Sabebus'}
		pick_tp_weapon()
...
function set_healbot()
		...
		send_command('wait 8; input //hb assist Enuri')
		send_command('wait 8; input //hb debuff carnage elegy')
		send_command('wait 8; input //hb debuff foe requiem vii')
end 