...
sets.brd = {
    ...
    string_inst = {
        range="Terpander"},}--put your string instrument here Terpander
sets.Idle = {
    ...
    if type(commandArgs) == 'table' and commandArgs[1] == 'start' then
        for i,v in ipairs(gs_skill.skillup_table) do
            if v:lower() == commandArgs[2]:lower() then
                ...
                local skill_id = {["Healing"]=35,["Enhancing"]=34,["Summoning"]=38,["Ninjutsu"]=39,["Singing"]=40,["Blue"]=43,["Geomancy"]=44}
